...
"[project]/src/app/api/admin/early-access/analytics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const totalVisits = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$AnalyticsVisit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const totalLeads = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$EarlyAccessLead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const convertedLeadsToTicket = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$EarlyAccessLead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
        ...
        const revenueResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$EarlyAccessLead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    convertedToTicket: true
                }
            },
            {
                $group: {
                    _id: null,
                    totalRevenue: {
                        $sum: '$ticketAmountPaid'
                    }
                }
            }
        ]);
        const totalEarlyAccessRevenue = revenueResult.length > 0 ? revenueResult[0].totalRevenue : 0;
        const sourceBreakdown = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$EarlyAccessLead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $group: {
                    _id: '$leadSource',
                    count: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ni17h-._.js.map