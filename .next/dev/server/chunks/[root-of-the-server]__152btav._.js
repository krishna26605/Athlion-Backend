...
"[project]/src/app/api/early-access/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!fullName || !email || !phone) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Please provide full name, email, and phone number', 400);
        }
        const normalizedEmail = email.toLowerCase().trim();
        let lead = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$EarlyAccessLead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        if (lead) {
            ...
            lead = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$EarlyAccessLead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
                fullName,
                email: normalizedEmail,
                phone,
        ...
        if (visitorId) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$AnalyticsVisit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateMany({
                visitorId
            }, {
                $set: {
                    convertedToEarlyAccess: true,
                    convertedUserEmail: normalizedEmail
                }
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__152btav._.js.map