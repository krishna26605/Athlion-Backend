...
async function GET(req) {
    try {
        const { user: authUser, errorResponse: authError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(req);
        if (authError) {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(authUser.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ku7av9._.js.map