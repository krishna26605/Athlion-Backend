...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$sendTokenResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils/sendTokenResponse.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        if (!email || !password) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Please provide an email and password', 400);
        }
        ...
        if (!user) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Invalid credentials', 401);
        }
        const isMatch = await user.matchPassword(password);
        if (!isMatch) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Invalid credentials', 401);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$sendTokenResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendTokenResponse"])(user, 200);
    } catch (err) {
...
"[project]/src/lib/utils/sendTokenResponse.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const sendTokenResponse = (user, statusCode = 200)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1rcyx5j._.js.map