...
"[project]/src/app/api/registrations/check-discount/[eventId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        const { user, errorResponse: authError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(req);
        if (authError) {
        ...
        const event = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(eventId);
        if (!event) {
        ...
        const existingRegWithCoupon = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$Registration$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            user: user.id,
            event: event._id,
        ...
        if (existingRegWithCoupon) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])({
                ...
                discount: {
                    type: 'none',
                    value: 0,
                    label: 'Already registered with a coupon'
                },
        ...
        const confirmedCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$Registration$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            event: event._id,
            paymentStatus: 'completed'
        });
        let discount = {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonResponse"])({
            ...
            originalPrice: event.price,
            finalPrice,
            spotsRemaining: confirmedCount < ebConfig.superEarlyLimit ? ebConfig.superEarlyLimit - confirmedCount : null
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00ythtg._.js.map