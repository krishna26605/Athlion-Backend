...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/models/Blog.ts [app-route] (ecmascript)");
...
async function GET(req) {
    try {
        ...
        let blogQuery = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
            createdAt: -1
        });
        if (limit) {
...
async function POST(req) {
    try {
        const { errorResponse: authError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireRole"])(req, 'admin', 'staff');
        if (authError) {
        ...
        const { title, slug, content, excerpt, category, coverImage, author, readTime, tags, metaTitle, metaDescription, isPublished } = body;
        if (!title || !content || !excerpt) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Title, excerpt, and content are required.', 400);
        }
        let generatedSlug = slug ? slugify(slug) : slugify(title);
        if (!generatedSlug) {
            generatedSlug = `article-${Date.now()}`;
        }
        const existingBlog = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            slug: generatedSlug
        });
        ...
        const processedTags = Array.isArray(tags) ? tags : typeof tags === 'string' ? tags.split(',').map((t)=>t.trim()).filter(Boolean) : [];
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            title,
            slug: finalSlug,
            content,
            excerpt,
        ...
        if (err.code === 11000) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('An article with this title or slug already exists.', 400);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(err.message || 'Failed to create blog post.', 400);
    }
}
}),
...
"[project]/src/lib/models/Blog.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs, [project]/node_modules/mongoose)");
;
const blogSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["Schema"]({
    title: {
        type: String,
        required: [
            true,
            'Please add a blog title'
        ],
        trim: true
    },
    slug: {
    ...
    excerpt: {
        ...
        required: [
            true,
            'Please add a short excerpt for SEO summary'
        ],
        trim: true
    },
    category: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1t03qds._.js.map